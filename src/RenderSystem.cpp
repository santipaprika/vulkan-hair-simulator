...
void RenderSystem::createPipeline(VkRenderPass renderPass) {
    ...
    shaderPaths.fragFilepath = "../shaders/simple_shader.frag.spv";
    shaderPaths.vertFilepath = "../shaders/simple_shader.vert.spv";
    std::vector<ShaderPaths> pipelinesShaderPaths = {shaderPaths, shaderPaths};
    ...
    pipelines = Pipeline::createGraphicsPipelines(
        ...
        std::vector<PipelineConfigInfo>({ pipelineConfig, pipelineConfig }),
